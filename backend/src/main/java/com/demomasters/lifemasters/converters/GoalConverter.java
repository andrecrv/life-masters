...
public class GoalConverter {
    ...
    public static GoalDTO toDTO(Goal goal) {
        return new GoalDTO(goal.getId(), goal.getUser().getId(), goal.getDescription(), goal.getStatus(), goal.getDifficulty(), goal.getGoalType(), goal.getExp(), goal.getCreateAtDate(), goal.getDueDate());
    }
    ...
    public static List<GoalDTO> toDTOList(List<Goal> goals) {
        return goals.stream()
                .map(goal -> new GoalDTO(goal.getId(), goal.getUser().getId(), goal.getDescription(), goal.getStatus(), goal.getDifficulty(), goal.getGoalType(), goal.getExp(), goal.getCreateAtDate(), goal.getDueDate()))
